...
/**
 * Created by parameht on 3/2/2018.
 */
...
import org.apache.nifi.phoenix.util.PhoenixJdbcCommon;
import org.apache.nifi.util.StopWatch;

import static org.apache.nifi.phoenix.util.PhoenixJdbcCommon.DEFAULT_PRECISION;
import static org.apache.nifi.phoenix.util.PhoenixJdbcCommon.DEFAULT_SCALE;
import static org.apache.nifi.phoenix.util.PhoenixJdbcCommon.NORMALIZE_NAMES_FOR_AVRO;
import static org.apache.nifi.phoenix.util.PhoenixJdbcCommon.USE_AVRO_LOGICAL_TYPES;

@EventDriven
@InputRequirement(Requirement.INPUT_ALLOWED)
@Tags({"sql", "select", "jdbc", "query", "phoenix"})
...
public class SelectPhoenixQL extends AbstractProcessor {
    ...
    public static final PropertyDescriptor PHOENIX_DBCP_SERVICE = new PropertyDescriptor.Builder()
            ...
            .required(true)
            .identifiesControllerService(PhoenixDBCPService.class)
            .build();
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try (final Connection con = dbcpService.getConnection();
            ...
            if (fileToProcess != null) {
                PhoenixJdbcCommon.setParameters(st, fileToProcess.getAttributes());
            }
            ...
            while(results){
                ...
                resultSetFF = session.write(resultSetFF, out -> {
                    try {
                        ...
                        final PhoenixJdbcCommon.AvroConversionOptions options = PhoenixJdbcCommon.AvroConversionOptions.builder()
                                .convertNames(convertNamesForAvro)
                                .useLogicalTypes(useAvroLogicalTypes)
                                .defaultPrecision(defaultPrecision)
                                .defaultScale(defaultScale)
                                .build();
                        nrOfRows.set(PhoenixJdbcCommon.convertToAvroStream(resultSet, out, options, null));
                ...
                resultSetFF = session.putAttribute(resultSetFF, CoreAttributes.MIME_TYPE.key(), PhoenixJdbcCommon.MIME_TYPE_AVRO_BINARY);
            ...
            if(fileToProcess != null){
                if(resultCount > 0){
                    ...
                    fileToProcess = session.write(fileToProcess, PhoenixJdbcCommon::createEmptyAvroStream);
