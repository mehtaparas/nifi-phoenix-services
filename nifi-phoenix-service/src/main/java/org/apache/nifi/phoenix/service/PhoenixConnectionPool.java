 ...
 */
package org.apache.nifi.phoenix.service;
...
/**
 * Implementation for Database Connection Pooling Service used for Apache Phoenix Connections.
 *
 * To Do -> Use HikariCP instead of Apache DBCP2 for pooling.
 *
 */

@RequiresInstanceClassLoading
@Tags({"phoenix", "jdbc", "database", "connection", "pooling", "hikaricp"})
...
public class PhoenixConnectionPool extends AbstractControllerService implements PhoenixDBCPService {

    public static final PropertyDescriptor DATABASE_URL = new PropertyDescriptor.Builder()
            .name("phoenix-db-connect-url")
            .displayName("Database Connection URL")
            .description("A database connection URL used to connect to a database. May contain database system name, host, port, database name and some parameters."
                    + " The exact syntax of a database connection URL is specified by the Apache Phoenix documentation. For example, the server principal is often included "
                    + "as a connection parameter when connecting to a secure Phoenix/HBase server.")
            .defaultValue(null)
    ...
    public static final PropertyDescriptor HBASE_CONFIGURATION_RESOURCES = new PropertyDescriptor.Builder()
            .name("hbase-config-resources")
            .displayName("HBase Configuration Resources")
            .description("A file or comma separated list of files which contains the HBase configuration (hbase-site.xml, e.g.). Without this, Hadoop "
                    ...
                    + "with Kerberos e.g., the appropriate properties must be set in the configuration files. Please see the HBase documentation for more details.")
            .required(false)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .expressionLanguageSupported(true)
            .build();
    ...
    public static final PropertyDescriptor MAX_TOTAL_CONNECTIONS = new PropertyDescriptor.Builder()
            .name("phoenix-max-total-connections")
    ...
    protected void init(final ControllerServiceInitializationContext context) {
        ...
        props.add(HBASE_CONFIGURATION_RESOURCES);
        props.add(DB_USER);
    ...
    protected Collection<ValidationResult> customValidate(ValidationContext validationContext) {
        boolean confFileProvided = validationContext.getProperty(HBASE_CONFIGURATION_RESOURCES).isSet();
    ...
    public String toString() {
        return "PhoenixConnectionPool[id=" + getIdentifier() + "]";
    }
